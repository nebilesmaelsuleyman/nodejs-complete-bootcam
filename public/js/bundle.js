      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'loged in succesfully');
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'passwrod or email fail');
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'error loging out');
        case 11:
        case "end":
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QTM86HJoBzUtcVnSRtkEtEQ77Kp20sUIu11pzqw59uoRuHHivZcpV3e6z9yMotesPrNfriJsE8S5aRHVa3KudLK00ftCrkEOT');
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            url: "".concat(location.origin, "/api/v1/bookings/checkout-session/").concat(tourId),
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    if (photoInput.file.length > 0) {
      ...
      (0, _alert.showAlert)('error', 'please select a photo to upload');
      return;
    }
    ...
    try {
      ...
      (0, _alert.showAlert)('error', 'failed to upload data.please try again ');
    }
  });
}
